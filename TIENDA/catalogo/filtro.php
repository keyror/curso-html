  ...
  <li class="list-group-item">
    <span class="badge bg-secondary mb-2"><i class="fa-solid fa-sd-card"></i> Almacenamiento</span> <br>
        ...
        <div class="form-check">
            ...
            <label class="form-check-label" for="inlineCheckbox4">512 gb</label>
        </div>
  </li>
  <li class="list-group-item">
    <span class="badge bg-secondary mb-2"><i class="fa-solid fa-sd-card"></i> Memoria ram</span> <br>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
            <label class="form-check-label" for="inlineCheckbox1">4 gb</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
            <label class="form-check-label" for="inlineCheckbox2">6 gb</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
            <label class="form-check-label" for="inlineCheckbox3">8 gb</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="option4">
            <label class="form-check-label" for="inlineCheckbox4">12 gb</label>
        </div>
  </li>
  <li class="list-group-item">
    <span class="badge bg-secondary mb-2"><i class="fa-solid fa-microchip"></i> Procesador</span> <br>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
            <label class="form-check-label" for="inlineCheckbox1">Snapdragon</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
            <label class="form-check-label" for="inlineCheckbox2">MediaTek</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
            <label class="form-check-label" for="inlineCheckbox3">Exynos</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="option4">
            <label class="form-check-label" for="inlineCheckbox4">Kirin</label>
        </div>
  </li>
  <li class="list-group-item">
    <span class="badge bg-secondary mb-2"><i class="fa-solid fa-palette"></i> Color</span> <br>
        <div class="form-check">
