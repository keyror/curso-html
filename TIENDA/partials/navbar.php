      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-6">
            <img src="" alt="">
            <div class="mapouter">
              <div class="gmap_canvas"><iframe width="323" height="323" id="gmap_canvas" src="https://maps.google.com/maps?q=2880%20Broadway,%20New%20York&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://putlocker-is.org">putlocker</a><br>
                <style>
                  .mapouter {
                    position: relative;
                    text-align: right;
                ...
                </style><a href="https://www.embedgooglemap.net">how to copy and paste google maps</a>
                <style>
                  .gmap_canvas {
                    overflow: hidden;
          ...
          <div class="col">
            <form class="row g-3">
              ...
              <div class="col-12">
                <label for="inputasubject" class="form-label">Asunto</label>
                <input type="text" class="form-control" id="inputasubject">
              </div>
              <div class="col-md-12">
            ...
            <div class="row mt-2">
              <div class="col">
                <p class="my-2 px-2 border-start border-secondary border-3 rounded"><strong> Email:</strong> email@gmail.com</p>
                <p class="px-2 border-start border-secondary border-3 rounded"><strong> Tel:</strong> 32158787448</p>
              </div>
            </div>
          </div>
        </div>
